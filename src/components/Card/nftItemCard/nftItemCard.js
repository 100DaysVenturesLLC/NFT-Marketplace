        ...
        <div class="card card-compact w-[280px] h-[358px] bg-[#121a23] backdrop-blur-xl bg-opacity-30">
            <div class="mt-1">
                <div class=" grid justify-items-center">
                    <div
                        class="flex flex-row flex justify-between  flex items-center w-[248px] h-[16px] text-white  text-[12px] leading-[16px] font-Montserrat mt-3 pb-[4px]">
                        <p class=" ml-1 font-medium">Modernist Masks</p>
                        <p class="font-light mr-1">20h:35m:08s</p>
                    </div>
                </div>
                <figure>
                    <img class="mt-3  w-[248px] h-[216px] " src={Image1} alt="Shoes" />
                </figure>
