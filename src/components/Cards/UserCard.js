      ...
      <div class="card card-compact w-[280px] h-[256px] user-card">
        <div className="realtive w-full h-full ">
          ...
          <div className="w-full h-[70px]">
            <div class="w-full p-5 h-2/5 overlay absolute bottom-0 flex dark:bg-white">
              <div class="flex items-center justify-between w-full ">
                <div className="flex items-center">
                  <div className="w-[40px] h-[40px] rounded-full absolute mb-[90px]">
                    <img src={ellipse} class="rounded-full "></img>
                  </div>
                  <div class="text-white flex flex-col h-[38px] mb-[5px] dark:text-foreground-secondary ">
                    <p class="card-title text-[12px] font-bold">Otherdeed</p>
                    <p class="text-[12px] font-light dark:text-[#6A8099] ">
                      50k Followers
                    </p>
                  </div>
                </div>
