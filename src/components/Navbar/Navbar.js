          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex  space-x-4 items-center">
                  ...
                  <form class="flex items-center">
                    ...
                    <div class="relative w-full">
                      ...
                      <input
                        type="text"
                        id="simple-search"
                        class="bg-[#303F50] w-5/6 text-white border border-[#303F50] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Search"
                        required
                      />
                    </div>
                ...
                <a
                  href="/explore"
                  className="hover:bg-gray-700 text-white px-6 py-2 rounded-md text-md font-bold"
                >
                  Explore
                </a>
                ...
                <a
                  href="/stats"
                  className="text-white hover:bg-gray-700 hover:text-white px-6 py-2 rounded-md text-md font-bold"
                >
                  Stats
                </a>
