...
const Card = ({resource,index}) => {
  ...
  return (
    <div key={index} class="card card-compact w-[580px] h-[330px]">
          ...
          <div class="w-full p-5 h-2/5 overlay  absolute bottom-0   flex  ">
            <div class="flex items-center justify-between w-full">
              <div className="flex items-center">
                <div className="">
                  <img src={resource.imageUrl} class="w-10 h-10 rounded-full"></img>
                </div>
                <div class="text-white flex flex-col	ml-5">
                  <h2 class="card-title text-xl">{resource.title}</h2>
