...
import colicon from "../../../assets/icons/Ellipse 5(1).png"
            ...
            <div class="drawer h-full">
                ...
                <div class="drawer-side">
                    ...
                    <ul class="menu p-4 overflow-y-auto bg-[#0C111A] w-80 text-base-content flex flex-col gap-3">
                        ...
                        <div class="collapse text-gray-100 text-sm collapse-arrow border-b-zinc-800 border-t-transparent border border-x-transparent">
                        ...
                        <div class="collapse text-gray-100 text-sm collapse-arrow border-b-zinc-800 border-t-transparent border border-x-transparent">
                            ...
                            <div class="collapse-content flex flex-col gap-4">
                                ...
                                <div className="btn secondary-btn-background">Apply</div>
                            </div>
                        </div>
                        <div class="collapse text-gray-100 text-sm collapse-arrow border-b-zinc-800 border-t-transparent border border-x-transparent">
                            <input type="checkbox" class="peer" />
                        ...
                        <div class="collapse text-gray-100 text-sm collapse-arrow border-b-zinc-800 border-t-transparent border border-x-transparent">
                            ...
                            <div class="collapse-content flex flex-col gap-4">
                                ...
                                <div className="flex gap-3 w-full py-2 border-[#6A809930] border-b">
                                    <img src={colicon} className="w-[38px]" alt="icon" />
