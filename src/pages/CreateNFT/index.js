            ...
            <div className="columns-2xl mr-5">
              ...
              <div className="flex flex-col mt-16">
                ...
                <div className="flex flex-col mt-16">
                  ...
                  <textarea
                    className="form-control block w-full px-3 py-1.5 text-base font-normal text-white bg-clip-padding border border-solid border-gray-300 rounded-lg transition bg-[#0c111a] ease-in-out m-0  focus:border-blue-600 focus:outline-none"
